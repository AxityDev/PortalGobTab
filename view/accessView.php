    ...
    <div class="col-sm-12">
        <table id="registros" class="table table-datatable table-sm table-striped" style="width:100%">
            ...
            <tbody>
                <?php
                if ($registrosAccesos) {
                    foreach ($registrosAccesos as $reg) {
                ...
                ?>
                        <tr>
                            ...
                            <td class="p-0"><button type="button" class="btn btn-sm text-danger p-0" data-id_usu="<?php echo $reg["usuarios_id_usuario"]; ?>" data-id_grupo="<?php echo $reg["grupos_tableros_id_gt"]; ?>" data-email_usu="<?php echo $reg["email_usuario"]; ?>" onclick="eliminarRegistro(this)"><i class="material-icons">delete_forever</i></button></td>
                        </tr>
                <?php
                    }
                }
